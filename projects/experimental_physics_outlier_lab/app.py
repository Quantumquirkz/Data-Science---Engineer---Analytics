...
from projects.experimental_physics_outlier_lab.src.config import SPEC
from projects.experimental_physics_outlier_lab.src.pipeline import run_experimental_physics_outlier_lab_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_experimental_physics_outlier_lab_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
