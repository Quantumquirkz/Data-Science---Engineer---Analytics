# Data Science L02: Python, NumPy, And pandas
...
In simple terms, this level helps you use the core Python data stack to inspect, clean, and transform evidence.
...
Complete or skim data_science:L01 first, then return here if a word feels unfamiliar.
...
- **Arrays**: explain what this means before you try to automate it.
- **Data frames**: identify where it appears in a table, notebook, model, system, or equation.
- **Vectorized thinking**: describe how it can mislead you if you ignore it.
...
Imagine predicting tomorrow's air quality. You first define the target, then decide which weather features are available before tomorrow, and finally check whether vectorized thinking could leak future information.
...
- I can say what `p014` / `demand_forecasting_for_cold_chain_logistics` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `Arrays` using a small example.
- I can explain `Data frames` using the project files or notebook.
- I can explain why `Vectorized thinking` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p014`
- Project slug: `demand_forecasting_for_cold_chain_logistics`
- Mission ID: `p014-ds-l02-m01`
- Central notebook: [`notebooks/tracks/data_science/L02/data_science_l02_python_numpy_and_pandas.ipynb`](../../../../../notebooks/tracks/data_science/L02/data_science_l02_python_numpy_and_pandas.ipynb)
- Project notebook: `projects/demand_forecasting_for_cold_chain_logistics/notebooks/demand_forecasting_for_cold_chain_logistics.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.demand_forecasting_for_cold_chain_logistics.src.pipeline
```
...
The next level is data_science:L03, where this idea becomes more technical.
