...
from projects.traffic_flow_as_a_physical_system.src.config import SPEC
from projects.traffic_flow_as_a_physical_system.src.pipeline import run_traffic_flow_as_a_physical_system_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_traffic_flow_as_a_physical_system_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
