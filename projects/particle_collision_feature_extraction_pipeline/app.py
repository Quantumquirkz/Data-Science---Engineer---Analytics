...
from projects.particle_collision_feature_extraction_pipeline.src.config import SPEC
from projects.particle_collision_feature_extraction_pipeline.src.pipeline import run_particle_collision_feature_extraction_pipeline_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_particle_collision_feature_extraction_pipeline_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
