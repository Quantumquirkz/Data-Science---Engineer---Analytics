# Scientific Computing L08: High-Performance Computing
...
In simple terms, this level helps you reason about memory, vectorization, and parallel workloads for simulation.
...
Complete or skim scientific_computing:L07 first, then return here if a word feels unfamiliar.
...
- **Memory bandwidth**: explain what this means before you try to automate it.
- **Parallel decomposition**: identify where it appears in a table, notebook, model, system, or equation.
- **Profiling**: describe how it can mislead you if you ignore it.
...
Imagine simulating a moving object. You name the state variables, attach units, and ask how profiling changes the trustworthiness of the computed trajectory.
...
- I can say what `p067` / `real_time_manufacturing_yield_dashboard` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `Memory bandwidth` using a small example.
- I can explain `Parallel decomposition` using the project files or notebook.
- I can explain why `Profiling` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p067`
- Project slug: `real_time_manufacturing_yield_dashboard`
- Mission ID: `p067-sc-l08-m01`
- Central notebook: [`notebooks/tracks/scientific_computing/L08/scientific_computing_l08_high_performance_computing.ipynb`](../../../../../notebooks/tracks/scientific_computing/L08/scientific_computing_l08_high_performance_computing.ipynb)
- Project notebook: `projects/real_time_manufacturing_yield_dashboard/notebooks/real_time_manufacturing_yield_dashboard.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.real_time_manufacturing_yield_dashboard.src.pipeline
```
...
The next level is scientific_computing:L09, where this idea becomes more technical.
