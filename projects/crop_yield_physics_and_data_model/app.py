...
from projects.crop_yield_physics_and_data_model.src.config import SPEC
from projects.crop_yield_physics_and_data_model.src.pipeline import run_crop_yield_physics_and_data_model_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_crop_yield_physics_and_data_model_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
