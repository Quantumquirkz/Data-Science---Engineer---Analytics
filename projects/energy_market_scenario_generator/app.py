...
from projects.energy_market_scenario_generator.src.config import SPEC
from projects.energy_market_scenario_generator.src.pipeline import run_energy_market_scenario_generator_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_energy_market_scenario_generator_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
