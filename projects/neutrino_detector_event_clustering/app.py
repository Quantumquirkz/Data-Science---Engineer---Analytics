...
from projects.neutrino_detector_event_clustering.src.config import SPEC
from projects.neutrino_detector_event_clustering.src.pipeline import run_neutrino_detector_event_clustering_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_neutrino_detector_event_clustering_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
