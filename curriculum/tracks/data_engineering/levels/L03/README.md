...
In simple terms, this level helps you choose tables, keys, and grain that preserve semantics.
...
Complete or skim data_engineering:L02 first, then return here if a word feels unfamiliar.
...
- **Normalization**: explain what this means before you try to automate it.
- **Join integrity**: identify where it appears in a table, notebook, model, system, or equation.
- **Entity boundaries**: describe how it can mislead you if you ignore it.
...
Imagine a folder of daily log files. You need to know where each file comes from, what schema it claims to follow, and how entity boundaries would appear when something breaks.
...
- I can explain `Normalization` using a small example.
- I can explain `Join integrity` using the project files or notebook.
- I can explain why `Entity boundaries` matters.
...
- Central notebook: [`notebooks/tracks/data_engineering/L03/data_engineering_l03_databases_and_data_modeling.ipynb`](../../../../../notebooks/tracks/data_engineering/L03/data_engineering_l03_databases_and_data_modeling.ipynb)
...
The next level is data_engineering:L04, where this idea becomes more technical.
