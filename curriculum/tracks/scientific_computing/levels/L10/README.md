# Scientific Computing L10: Reproducible Computational Science Capstone
...
In simple terms, this level helps you write and defend a computational study with numerical and scientific integrity.
...
Complete or skim scientific_computing:L09 first, then return here if a word feels unfamiliar.
...
- **Reproducible experiments**: explain what this means before you try to automate it.
- **Validation against theory**: identify where it appears in a table, notebook, model, system, or equation.
- **Scientific reporting**: describe how it can mislead you if you ignore it.
...
Imagine simulating a moving object. You name the state variables, attach units, and ask how scientific reporting changes the trustworthiness of the computed trajectory.
...
- I can say what `p100` / `wind_turbine_failure_early_warning_system` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `Reproducible experiments` using a small example.
- I can explain `Validation against theory` using the project files or notebook.
- I can explain why `Scientific reporting` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p100`
- Project slug: `wind_turbine_failure_early_warning_system`
- Mission ID: `p100-sc-l10-m01`
- Central notebook: [`notebooks/tracks/scientific_computing/L10/scientific_computing_l10_reproducible_computational_science_capstone.ipynb`](../../../../../notebooks/tracks/scientific_computing/L10/scientific_computing_l10_reproducible_computational_science_capstone.ipynb)
- Project notebook: `projects/wind_turbine_failure_early_warning_system/notebooks/wind_turbine_failure_early_warning_system.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.wind_turbine_failure_early_warning_system.src.pipeline
```
