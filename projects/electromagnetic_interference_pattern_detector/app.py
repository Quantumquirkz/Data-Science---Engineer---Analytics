...
from projects.electromagnetic_interference_pattern_detector.src.config import SPEC
from projects.electromagnetic_interference_pattern_detector.src.pipeline import run_electromagnetic_interference_pattern_detector_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_electromagnetic_interference_pattern_detector_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
