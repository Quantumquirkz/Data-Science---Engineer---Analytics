...
from projects.financial_contagion_network_model.src.config import SPEC
from projects.financial_contagion_network_model.src.pipeline import run_financial_contagion_network_model_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_financial_contagion_network_model_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
