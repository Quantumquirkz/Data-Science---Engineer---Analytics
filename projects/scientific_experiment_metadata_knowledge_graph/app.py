...
from projects.scientific_experiment_metadata_knowledge_graph.src.config import SPEC
from projects.scientific_experiment_metadata_knowledge_graph.src.pipeline import run_scientific_experiment_metadata_knowledge_graph_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_scientific_experiment_metadata_knowledge_graph_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
