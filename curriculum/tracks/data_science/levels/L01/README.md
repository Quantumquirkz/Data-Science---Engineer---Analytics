# Data Science L01: Scientific Questions
...
In simple terms, this level helps you frame data work as questions, observations, hypotheses, and measurable targets.
...
- **Question formulation**: explain what this means before you try to automate it.
- **Observational units**: identify where it appears in a table, notebook, model, system, or equation.
- **Target leakage intuition**: describe how it can mislead you if you ignore it.
...
Imagine predicting tomorrow's air quality. You first define the target, then decide which weather features are available before tomorrow, and finally check whether target leakage intuition could leak future information.
...
- I can say what `p002` / `air_quality_hotspot_prediction` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `Question formulation` using a small example.
- I can explain `Observational units` using the project files or notebook.
- I can explain why `Target leakage intuition` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p002`
- Project slug: `air_quality_hotspot_prediction`
- Mission ID: `p002-ds-l01-m01`
- Central notebook: [`notebooks/tracks/data_science/L01/data_science_l01_scientific_questions.ipynb`](../../../../../notebooks/tracks/data_science/L01/data_science_l01_scientific_questions.ipynb)
- Project notebook: `projects/air_quality_hotspot_prediction/notebooks/air_quality_hotspot_prediction.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.air_quality_hotspot_prediction.src.pipeline
```
...
The next level is data_science:L02, where this idea becomes more technical.
