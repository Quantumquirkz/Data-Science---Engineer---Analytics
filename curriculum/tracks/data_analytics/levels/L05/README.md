# Data Analytics L05: Business Metrics And Decisions
...
In simple terms, this level helps you translate metrics into operational levers and constraints.
...
Complete or skim data_analytics:L04 first, then return here if a word feels unfamiliar.
...
- **North-star metrics**: explain what this means before you try to automate it.
- **Trade-off analysis**: identify where it appears in a table, notebook, model, system, or equation.
- **Sensitivity to assumptions**: describe how it can mislead you if you ignore it.
...
Imagine a table with one row per day. Before making a chart, ask what each row means, what metric is being counted, and whether sensitivity to assumptions could change the interpretation.
...
- I can explain `North-star metrics` using a small example.
- I can explain `Trade-off analysis` using the project files or notebook.
- I can explain why `Sensitivity to assumptions` matters.
...
- Mission ID: `p041-da-l05-m01`
- Central notebook: [`notebooks/tracks/data_analytics/L05/data_analytics_l05_business_metrics_and_decisions.ipynb`](../../../../../notebooks/tracks/data_analytics/L05/data_analytics_l05_business_metrics_and_decisions.ipynb)
...
The next level is data_analytics:L06, where this idea becomes more technical.
