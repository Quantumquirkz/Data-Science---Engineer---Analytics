...
from projects.thermal_camera_defect_detection.src.config import SPEC
from projects.thermal_camera_defect_detection.src.pipeline import run_thermal_camera_defect_detection_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_thermal_camera_defect_detection_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
