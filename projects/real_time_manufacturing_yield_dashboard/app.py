...
from projects.real_time_manufacturing_yield_dashboard.src.config import SPEC
from projects.real_time_manufacturing_yield_dashboard.src.pipeline import run_real_time_manufacturing_yield_dashboard_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_real_time_manufacturing_yield_dashboard_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
