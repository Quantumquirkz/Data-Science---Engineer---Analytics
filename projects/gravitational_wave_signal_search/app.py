...
from projects.gravitational_wave_signal_search.src.config import SPEC
from projects.gravitational_wave_signal_search.src.pipeline import run_gravitational_wave_signal_search_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_gravitational_wave_signal_search_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
