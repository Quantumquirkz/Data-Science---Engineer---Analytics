...
from projects.renewable_energy_mix_optimizer.src.config import SPEC
...
def _load_pipeline(n_samples: int):
    return run_renewable_energy_mix_optimizer_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
