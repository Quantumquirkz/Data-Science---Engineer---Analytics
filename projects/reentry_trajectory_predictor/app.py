...
from projects.reentry_trajectory_predictor.src.config import SPEC
from projects.reentry_trajectory_predictor.src.pipeline import run_reentry_trajectory_predictor_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_reentry_trajectory_predictor_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
