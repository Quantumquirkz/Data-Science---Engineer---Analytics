...
from projects.autonomous_vehicle_sensor_fusion_project.src.config import SPEC
from projects.autonomous_vehicle_sensor_fusion_project.src.pipeline import run_autonomous_vehicle_sensor_fusion_project_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_autonomous_vehicle_sensor_fusion_project_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
