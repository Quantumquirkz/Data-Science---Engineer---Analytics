...
from projects.large_scale_sensor_missing_data_imputation.src.config import SPEC
from projects.large_scale_sensor_missing_data_imputation.src.pipeline import run_large_scale_sensor_missing_data_imputation_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_large_scale_sensor_missing_data_imputation_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
