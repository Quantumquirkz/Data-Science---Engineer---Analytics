...
from projects.optical_experiment_noise_characterization.src.config import SPEC
from projects.optical_experiment_noise_characterization.src.pipeline import run_optical_experiment_noise_characterization_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_optical_experiment_noise_characterization_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
