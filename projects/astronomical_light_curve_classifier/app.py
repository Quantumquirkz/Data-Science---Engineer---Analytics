...
from projects.astronomical_light_curve_classifier.src.config import SPEC
from projects.astronomical_light_curve_classifier.src.pipeline import run_astronomical_light_curve_classifier_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_astronomical_light_curve_classifier_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
