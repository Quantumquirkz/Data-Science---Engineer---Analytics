# Data Analytics L03: Descriptive Analytics
...
In simple terms, this level helps you summarize central tendency, spread, segmentation, and anomalies.
...
Complete or skim data_analytics:L02 first, then return here if a word feels unfamiliar.
...
- **Distributions**: explain what this means before you try to automate it.
- **Percentiles**: identify where it appears in a table, notebook, model, system, or equation.
- **Cohorts**: describe how it can mislead you if you ignore it.
...
Imagine a table with one row per day. Before making a chart, ask what each row means, what metric is being counted, and whether cohorts could change the interpretation.
...
- I can say what `p019` / `energy_market_scenario_generator` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `Distributions` using a small example.
- I can explain `Percentiles` using the project files or notebook.
- I can explain why `Cohorts` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p019`
- Project slug: `energy_market_scenario_generator`
- Mission ID: `p019-da-l03-m01`
- Central notebook: [`notebooks/tracks/data_analytics/L03/data_analytics_l03_descriptive_analytics.ipynb`](../../../../../notebooks/tracks/data_analytics/L03/data_analytics_l03_descriptive_analytics.ipynb)
- Project notebook: `projects/energy_market_scenario_generator/notebooks/energy_market_scenario_generator.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.energy_market_scenario_generator.src.pipeline
```
...
The next level is data_analytics:L04, where this idea becomes more technical.
