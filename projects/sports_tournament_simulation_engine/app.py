...
from projects.sports_tournament_simulation_engine.src.config import SPEC
from projects.sports_tournament_simulation_engine.src.pipeline import run_sports_tournament_simulation_engine_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_sports_tournament_simulation_engine_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
