# Data Analytics L01: Data Literacy
...
In simple terms, this level helps you read tables, units, categories, and variation before touching tools.
...
- **What is a row?**: explain what this means before you try to automate it.
- **What is a metric?**: identify where it appears in a table, notebook, model, system, or equation.
- **How do units distort interpretation?**: describe how it can mislead you if you ignore it.
...
Imagine a table with one row per day. Before making a chart, ask what each row means, what metric is being counted, and whether how do units distort interpretation? could change the interpretation.
...
- I can say what `p023` / `experimental_reproducibility_analytics` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `What is a row?` using a small example.
- I can explain `What is a metric?` using the project files or notebook.
- I can explain why `How do units distort interpretation?` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p023`
- Project slug: `experimental_reproducibility_analytics`
- Mission ID: `p023-da-l01-m01`
- Central notebook: [`notebooks/tracks/data_analytics/L01/data_analytics_l01_data_literacy.ipynb`](../../../../../notebooks/tracks/data_analytics/L01/data_analytics_l01_data_literacy.ipynb)
- Project notebook: `projects/experimental_reproducibility_analytics/notebooks/experimental_reproducibility_analytics.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.experimental_reproducibility_analytics.src.pipeline
```
...
The next level is data_analytics:L02, where this idea becomes more technical.
