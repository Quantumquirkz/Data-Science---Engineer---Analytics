# Scientific Computing L05: Simulation And Dynamical Systems
...
In simple terms, this level helps you model interacting systems and interpret phase behavior.
...
Complete or skim scientific_computing:L04 first, then return here if a word feels unfamiliar.
...
- **State evolution**: explain what this means before you try to automate it.
- **Conservation laws**: identify where it appears in a table, notebook, model, system, or equation.
- **Phase portraits**: describe how it can mislead you if you ignore it.
...
Imagine simulating a moving object. You name the state variables, attach units, and ask how phase portraits changes the trustworthiness of the computed trajectory.
...
- I can say what `p030` / `gravitational_wave_signal_search` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `State evolution` using a small example.
- I can explain `Conservation laws` using the project files or notebook.
- I can explain why `Phase portraits` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p030`
- Project slug: `gravitational_wave_signal_search`
- Mission ID: `p030-sc-l05-m01`
- Central notebook: [`notebooks/tracks/scientific_computing/L05/scientific_computing_l05_simulation_and_dynamical_systems.ipynb`](../../../../../notebooks/tracks/scientific_computing/L05/scientific_computing_l05_simulation_and_dynamical_systems.ipynb)
- Project notebook: `projects/gravitational_wave_signal_search/notebooks/gravitational_wave_signal_search.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.gravitational_wave_signal_search.src.pipeline
```
...
The next level is scientific_computing:L06, where this idea becomes more technical.
