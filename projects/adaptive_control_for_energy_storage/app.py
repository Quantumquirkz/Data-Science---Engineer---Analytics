...
from projects.adaptive_control_for_energy_storage.src.config import SPEC
from projects.adaptive_control_for_energy_storage.src.pipeline import run_adaptive_control_for_energy_storage_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_adaptive_control_for_energy_storage_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
