...
from projects.scientific_image_segmentation_benchmark.src.config import SPEC
from projects.scientific_image_segmentation_benchmark.src.pipeline import run_scientific_image_segmentation_benchmark_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_scientific_image_segmentation_benchmark_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
