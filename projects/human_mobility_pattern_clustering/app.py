...
from projects.human_mobility_pattern_clustering.src.config import SPEC
from projects.human_mobility_pattern_clustering.src.pipeline import run_human_mobility_pattern_clustering_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_human_mobility_pattern_clustering_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
