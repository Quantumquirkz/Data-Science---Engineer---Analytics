...
from projects.research_trend_forecasting_engine.src.config import SPEC
from projects.research_trend_forecasting_engine.src.pipeline import run_research_trend_forecasting_engine_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_research_trend_forecasting_engine_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
