# ML Engineering L01: Software Foundations
...
In simple terms, this level helps you treat scripts, modules, tests, and environments as first-class ML assets.
...
- **Python package boundaries**: explain what this means before you try to automate it.
- **CLI execution**: identify where it appears in a table, notebook, model, system, or equation.
- **Determinism intuition**: describe how it can mislead you if you ignore it.
...
Imagine a trained model inside an app. You need to know where the package boundary is, how to call it, and how determinism intuition affects repeated runs.
...
- I can explain `Python package boundaries` using a small example.
- I can explain `CLI execution` using the project files or notebook.
- I can explain why `Determinism intuition` matters.
...
- Mission ID: `p034-mle-l01-m01`
- Central notebook: [`notebooks/tracks/ml_engineering/L01/ml_engineering_l01_software_foundations.ipynb`](../../../../../notebooks/tracks/ml_engineering/L01/ml_engineering_l01_software_foundations.ipynb)
...
The next level is ml_engineering:L02, where this idea becomes more technical.
