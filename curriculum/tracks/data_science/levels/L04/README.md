# Data Science L04: Experimental Design And Inference
...
In simple terms, this level helps you separate causal claims, correlations, and measurement bias.
...
Complete or skim data_science:L03 first, then return here if a word feels unfamiliar.
...
- **Counterfactual reasoning**: explain what this means before you try to automate it.
- **Confounding**: identify where it appears in a table, notebook, model, system, or equation.
- **Confidence intervals**: describe how it can mislead you if you ignore it.
...
Imagine predicting tomorrow's air quality. You first define the target, then decide which weather features are available before tomorrow, and finally check whether confidence intervals could leak future information.
...
- I can say what `p026` / `financial_volatility_surface_predictor` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `Counterfactual reasoning` using a small example.
- I can explain `Confounding` using the project files or notebook.
- I can explain why `Confidence intervals` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p026`
- Project slug: `financial_volatility_surface_predictor`
- Mission ID: `p026-ds-l04-m01`
- Central notebook: [`notebooks/tracks/data_science/L04/data_science_l04_experimental_design_and_inference.ipynb`](../../../../../notebooks/tracks/data_science/L04/data_science_l04_experimental_design_and_inference.ipynb)
- Project notebook: `projects/financial_volatility_surface_predictor/notebooks/financial_volatility_surface_predictor.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.financial_volatility_surface_predictor.src.pipeline
```
...
The next level is data_science:L05, where this idea becomes more technical.
