...
from projects.shockwave_event_detection_in_sensor_arrays.src.config import SPEC
from projects.shockwave_event_detection_in_sensor_arrays.src.pipeline import run_shockwave_event_detection_in_sensor_arrays_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_shockwave_event_detection_in_sensor_arrays_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
