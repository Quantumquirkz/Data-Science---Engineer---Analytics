...
from projects.computational_topology_for_data_shapes.src.config import SPEC
from projects.computational_topology_for_data_shapes.src.pipeline import run_computational_topology_for_data_shapes_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_computational_topology_for_data_shapes_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
