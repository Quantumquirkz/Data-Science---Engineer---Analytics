...
from projects.sports_biomechanics_motion_analyzer.src.config import SPEC
from projects.sports_biomechanics_motion_analyzer.src.pipeline import run_sports_biomechanics_motion_analyzer_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_sports_biomechanics_motion_analyzer_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
