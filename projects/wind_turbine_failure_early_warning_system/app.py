...
from projects.wind_turbine_failure_early_warning_system.src.config import SPEC
from projects.wind_turbine_failure_early_warning_system.src.pipeline import run_wind_turbine_failure_early_warning_system_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_wind_turbine_failure_early_warning_system_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
