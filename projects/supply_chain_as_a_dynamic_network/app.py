...
from projects.supply_chain_as_a_dynamic_network.src.config import SPEC
from projects.supply_chain_as_a_dynamic_network.src.pipeline import run_supply_chain_as_a_dynamic_network_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_supply_chain_as_a_dynamic_network_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
