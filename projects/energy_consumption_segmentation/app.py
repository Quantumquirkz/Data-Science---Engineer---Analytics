...
from projects.energy_consumption_segmentation.src.config import SPEC
from projects.energy_consumption_segmentation.src.pipeline import run_energy_consumption_segmentation_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_energy_consumption_segmentation_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
