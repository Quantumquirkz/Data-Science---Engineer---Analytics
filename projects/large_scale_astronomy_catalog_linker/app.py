...
from projects.large_scale_astronomy_catalog_linker.src.config import SPEC
from projects.large_scale_astronomy_catalog_linker.src.pipeline import run_large_scale_astronomy_catalog_linker_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_large_scale_astronomy_catalog_linker_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
