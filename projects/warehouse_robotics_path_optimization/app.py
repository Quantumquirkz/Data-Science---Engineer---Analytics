...
from projects.warehouse_robotics_path_optimization.src.config import SPEC
from projects.warehouse_robotics_path_optimization.src.pipeline import run_warehouse_robotics_path_optimization_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_warehouse_robotics_path_optimization_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
