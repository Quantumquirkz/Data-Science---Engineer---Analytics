...
from projects.reinforcement_learning_for_adaptive_traffic_lights.src.config import SPEC
from projects.reinforcement_learning_for_adaptive_traffic_lights.src.pipeline import run_reinforcement_learning_for_adaptive_traffic_lights_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_reinforcement_learning_for_adaptive_traffic_lights_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
