...
from projects.demand_forecasting_for_cold_chain_logistics.src.config import SPEC
from projects.demand_forecasting_for_cold_chain_logistics.src.pipeline import run_demand_forecasting_for_cold_chain_logistics_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_demand_forecasting_for_cold_chain_logistics_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
