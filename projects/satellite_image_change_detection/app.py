...
from projects.satellite_image_change_detection.src.config import SPEC
from projects.satellite_image_change_detection.src.pipeline import run_satellite_image_change_detection_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_satellite_image_change_detection_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
