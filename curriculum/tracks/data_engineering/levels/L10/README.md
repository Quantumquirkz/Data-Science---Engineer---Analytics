# Data Engineering L10: Production Data Platform Capstone
...
In simple terms, this level helps you defend a full platform design with reliability, observability, and change management.
...
Complete or skim data_engineering:L09 first, then return here if a word feels unfamiliar.
...
- **Operational SLOs**: explain what this means before you try to automate it.
- **Platform contracts**: identify where it appears in a table, notebook, model, system, or equation.
- **Migration plans**: describe how it can mislead you if you ignore it.
...
Imagine a folder of daily log files. You need to know where each file comes from, what schema it claims to follow, and how migration plans would appear when something breaks.
...
- I can say what `p084` / `smart_building_thermal_dynamics_model` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `Operational SLOs` using a small example.
- I can explain `Platform contracts` using the project files or notebook.
- I can explain why `Migration plans` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p084`
- Project slug: `smart_building_thermal_dynamics_model`
- Mission ID: `p084-de-l10-m01`
- Central notebook: [`notebooks/tracks/data_engineering/L10/data_engineering_l10_production_data_platform_capstone.ipynb`](../../../../../notebooks/tracks/data_engineering/L10/data_engineering_l10_production_data_platform_capstone.ipynb)
- Project notebook: `projects/smart_building_thermal_dynamics_model/notebooks/smart_building_thermal_dynamics_model.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.smart_building_thermal_dynamics_model.src.pipeline
```
