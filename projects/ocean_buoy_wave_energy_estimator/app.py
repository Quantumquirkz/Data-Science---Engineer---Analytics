...
from projects.ocean_buoy_wave_energy_estimator.src.config import SPEC
from projects.ocean_buoy_wave_energy_estimator.src.pipeline import run_ocean_buoy_wave_energy_estimator_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_ocean_buoy_wave_energy_estimator_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
