...
from projects.recommender_system_for_scientific_papers.src.config import SPEC
from projects.recommender_system_for_scientific_papers.src.pipeline import run_recommender_system_for_scientific_papers_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_recommender_system_for_scientific_papers_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
