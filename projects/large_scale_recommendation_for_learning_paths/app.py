...
from projects.large_scale_recommendation_for_learning_paths.src.config import SPEC
from projects.large_scale_recommendation_for_learning_paths.src.pipeline import run_large_scale_recommendation_for_learning_paths_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_large_scale_recommendation_for_learning_paths_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
