...
from projects.wildfire_spread_prediction.src.config import SPEC
from projects.wildfire_spread_prediction.src.pipeline import run_wildfire_spread_prediction_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_wildfire_spread_prediction_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
