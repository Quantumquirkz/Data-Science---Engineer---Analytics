...
from projects.spectroscopy_peak_detection_engine.src.config import SPEC
from projects.spectroscopy_peak_detection_engine.src.pipeline import run_spectroscopy_peak_detection_engine_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_spectroscopy_peak_detection_engine_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
