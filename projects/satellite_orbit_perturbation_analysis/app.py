...
from projects.satellite_orbit_perturbation_analysis.src.config import SPEC
from projects.satellite_orbit_perturbation_analysis.src.pipeline import run_satellite_orbit_perturbation_analysis_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_satellite_orbit_perturbation_analysis_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
