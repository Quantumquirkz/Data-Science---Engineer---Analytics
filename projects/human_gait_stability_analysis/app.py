...
from projects.human_gait_stability_analysis.src.config import SPEC
from projects.human_gait_stability_analysis.src.pipeline import run_human_gait_stability_analysis_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_human_gait_stability_analysis_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
