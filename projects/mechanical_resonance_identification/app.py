...
from projects.mechanical_resonance_identification.src.config import SPEC
from projects.mechanical_resonance_identification.src.pipeline import run_mechanical_resonance_identification_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_mechanical_resonance_identification_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
