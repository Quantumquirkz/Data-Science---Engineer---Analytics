...
from projects.smart_grid_fault_localization.src.config import SPEC
from projects.smart_grid_fault_localization.src.pipeline import run_smart_grid_fault_localization_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_smart_grid_fault_localization_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
