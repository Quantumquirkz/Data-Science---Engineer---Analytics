...
from projects.portfolio_risk_stress_testing_engine.src.config import SPEC
from projects.portfolio_risk_stress_testing_engine.src.pipeline import run_portfolio_risk_stress_testing_engine_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_portfolio_risk_stress_testing_engine_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
