...
from projects.data_assimilation_for_environmental_systems.src.config import SPEC
from projects.data_assimilation_for_environmental_systems.src.pipeline import run_data_assimilation_for_environmental_systems_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_data_assimilation_for_environmental_systems_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
