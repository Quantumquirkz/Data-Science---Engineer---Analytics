...
from projects.multi_agent_evacuation_simulation.src.config import SPEC
from projects.multi_agent_evacuation_simulation.src.pipeline import run_multi_agent_evacuation_simulation_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_multi_agent_evacuation_simulation_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
