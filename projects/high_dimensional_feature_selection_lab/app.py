...
from projects.high_dimensional_feature_selection_lab.src.config import SPEC
from projects.high_dimensional_feature_selection_lab.src.pipeline import run_high_dimensional_feature_selection_lab_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_high_dimensional_feature_selection_lab_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
