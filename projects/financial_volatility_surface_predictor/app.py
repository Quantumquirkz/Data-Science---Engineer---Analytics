...
from projects.financial_volatility_surface_predictor.src.config import SPEC
from projects.financial_volatility_surface_predictor.src.pipeline import run_financial_volatility_surface_predictor_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_financial_volatility_surface_predictor_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
