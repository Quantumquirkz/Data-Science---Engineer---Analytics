...
from projects.network_traffic_anomaly_detection.src.config import SPEC
from projects.network_traffic_anomaly_detection.src.pipeline import run_network_traffic_anomaly_detection_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_network_traffic_anomaly_detection_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
