...
from projects.airplane_turbulence_pattern_mining.src.config import SPEC
from projects.airplane_turbulence_pattern_mining.src.pipeline import run_airplane_turbulence_pattern_mining_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_airplane_turbulence_pattern_mining_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
