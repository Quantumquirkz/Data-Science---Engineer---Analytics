...
from projects.hospital_queue_dynamics_analyzer.src.config import SPEC
from projects.hospital_queue_dynamics_analyzer.src.pipeline import run_hospital_queue_dynamics_analyzer_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_hospital_queue_dynamics_analyzer_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
