...
from projects.large_scale_text_mining_of_scientific_literature.src.config import SPEC
from projects.large_scale_text_mining_of_scientific_literature.src.pipeline import run_large_scale_text_mining_of_scientific_literature_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_large_scale_text_mining_of_scientific_literature_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
