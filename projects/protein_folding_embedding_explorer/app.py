...
from projects.protein_folding_embedding_explorer.src.config import SPEC
from projects.protein_folding_embedding_explorer.src.pipeline import run_protein_folding_embedding_explorer_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_protein_folding_embedding_explorer_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
