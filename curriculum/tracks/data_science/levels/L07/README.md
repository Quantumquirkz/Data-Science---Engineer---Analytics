# Data Science L07: Time Series And Forecasting
...
In simple terms, this level helps you model sequential dependence and forecast under temporal leakage constraints.
...
Complete or skim data_science:L06 first, then return here if a word feels unfamiliar.
...
- **Lag structure**: explain what this means before you try to automate it.
- **Backtesting**: identify where it appears in a table, notebook, model, system, or equation.
- **Regime shifts**: describe how it can mislead you if you ignore it.
...
Imagine predicting tomorrow's air quality. You first define the target, then decide which weather features are available before tomorrow, and finally check whether regime shifts could leak future information.
...
- I can say what `p034` / `human_activity_recognition_from_wearables` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `Lag structure` using a small example.
- I can explain `Backtesting` using the project files or notebook.
- I can explain why `Regime shifts` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p034`
- Project slug: `human_activity_recognition_from_wearables`
- Mission ID: `p034-ds-l07-m01`
- Central notebook: [`notebooks/tracks/data_science/L07/data_science_l07_time_series_and_forecasting.ipynb`](../../../../../notebooks/tracks/data_science/L07/data_science_l07_time_series_and_forecasting.ipynb)
- Project notebook: `projects/human_activity_recognition_from_wearables/notebooks/human_activity_recognition_from_wearables.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.human_activity_recognition_from_wearables.src.pipeline
```
...
The next level is data_science:L08, where this idea becomes more technical.
