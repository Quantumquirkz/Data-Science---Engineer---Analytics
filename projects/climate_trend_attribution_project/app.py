...
from projects.climate_trend_attribution_project.src.config import SPEC
from projects.climate_trend_attribution_project.src.pipeline import run_climate_trend_attribution_project_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_climate_trend_attribution_project_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
