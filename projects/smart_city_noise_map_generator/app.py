...
from projects.smart_city_noise_map_generator.src.config import SPEC
from projects.smart_city_noise_map_generator.src.pipeline import run_smart_city_noise_map_generator_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_smart_city_noise_map_generator_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
