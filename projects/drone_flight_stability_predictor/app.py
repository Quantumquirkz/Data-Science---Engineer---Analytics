...
from projects.drone_flight_stability_predictor.src.config import SPEC
from projects.drone_flight_stability_predictor.src.pipeline import run_drone_flight_stability_predictor_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_drone_flight_stability_predictor_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
