# Scientific Computing L01: Mathematical Measurement
...
In simple terms, this level helps you start from quantities, units, coordinates, and approximation as the basis of simulation.
...
- **State variables**: explain what this means before you try to automate it.
- **Units**: identify where it appears in a table, notebook, model, system, or equation.
- **Approximation error intuition**: describe how it can mislead you if you ignore it.
...
Imagine simulating a moving object. You name the state variables, attach units, and ask how approximation error intuition changes the trustworthiness of the computed trajectory.
...
- I can say what `p029` / `gravitational_orbit_simulator` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `State variables` using a small example.
- I can explain `Units` using the project files or notebook.
- I can explain why `Approximation error intuition` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p029`
- Project slug: `gravitational_orbit_simulator`
- Mission ID: `p029-sc-l01-m01`
- Central notebook: [`notebooks/tracks/scientific_computing/L01/scientific_computing_l01_mathematical_measurement.ipynb`](../../../../../notebooks/tracks/scientific_computing/L01/scientific_computing_l01_mathematical_measurement.ipynb)
- Project notebook: `projects/gravitational_orbit_simulator/notebooks/gravitational_orbit_simulator.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.gravitational_orbit_simulator.src.pipeline
```
...
The next level is scientific_computing:L02, where this idea becomes more technical.
