...
from projects.plasma_experiment_parameter_inference.src.config import SPEC
from projects.plasma_experiment_parameter_inference.src.pipeline import run_plasma_experiment_parameter_inference_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_plasma_experiment_parameter_inference_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
