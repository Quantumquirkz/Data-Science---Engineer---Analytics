...
from projects.high_frequency_trading_microstructure_analyzer.src.config import SPEC
from projects.high_frequency_trading_microstructure_analyzer.src.pipeline import run_high_frequency_trading_microstructure_analyzer_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_high_frequency_trading_microstructure_analyzer_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
