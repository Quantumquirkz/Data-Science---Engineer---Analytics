...
from projects.environmental_sensor_network_placement_optimizer.src.config import SPEC
from projects.environmental_sensor_network_placement_optimizer.src.pipeline import run_environmental_sensor_network_placement_optimizer_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_environmental_sensor_network_placement_optimizer_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
