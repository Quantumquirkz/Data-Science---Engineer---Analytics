...
from projects.radiative_cooling_efficiency_predictor.src.config import SPEC
from projects.radiative_cooling_efficiency_predictor.src.pipeline import run_radiative_cooling_efficiency_predictor_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_radiative_cooling_efficiency_predictor_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
