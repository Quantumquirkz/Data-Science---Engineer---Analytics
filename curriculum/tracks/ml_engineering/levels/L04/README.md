# ML Engineering L04: Reproducible Training Pipelines
...
In simple terms, this level helps you capture seeds, configs, and dependencies so results can be repeated.
...
Complete or skim ml_engineering:L03 first, then return here if a word feels unfamiliar.
...
- **Configuration surfaces**: explain what this means before you try to automate it.
- **Artifact capture**: identify where it appears in a table, notebook, model, system, or equation.
- **Experiment traceability**: describe how it can mislead you if you ignore it.
...
Imagine a trained model inside an app. You need to know where the package boundary is, how to call it, and how experiment traceability affects repeated runs.
...
- I can say what `p050` / `neuron_spike_train_modeling` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `Configuration surfaces` using a small example.
- I can explain `Artifact capture` using the project files or notebook.
- I can explain why `Experiment traceability` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p050`
- Project slug: `neuron_spike_train_modeling`
- Mission ID: `p050-mle-l04-m01`
- Central notebook: [`notebooks/tracks/ml_engineering/L04/ml_engineering_l04_reproducible_training_pipelines.ipynb`](../../../../../notebooks/tracks/ml_engineering/L04/ml_engineering_l04_reproducible_training_pipelines.ipynb)
- Project notebook: `projects/neuron_spike_train_modeling/notebooks/neuron_spike_train_modeling.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.neuron_spike_train_modeling.src.pipeline
```
...
The next level is ml_engineering:L05, where this idea becomes more technical.
