...
from projects.rare_disease_signal_mining.src.config import SPEC
from projects.rare_disease_signal_mining.src.pipeline import run_rare_disease_signal_mining_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_rare_disease_signal_mining_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
