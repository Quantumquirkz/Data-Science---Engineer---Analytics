...
from projects.experimental_reproducibility_analytics.src.config import SPEC
from projects.experimental_reproducibility_analytics.src.pipeline import run_experimental_reproducibility_analytics_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_experimental_reproducibility_analytics_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
