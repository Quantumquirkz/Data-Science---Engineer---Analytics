# Data Engineering L05: Data Quality And Contracts
...
In simple terms, this level helps you express data validity as contracts, tests, and observability.
...
Complete or skim data_engineering:L04 first, then return here if a word feels unfamiliar.
...
- **Null policy**: explain what this means before you try to automate it.
- **Range checks**: identify where it appears in a table, notebook, model, system, or equation.
- **Schema contracts**: describe how it can mislead you if you ignore it.
...
Imagine a folder of daily log files. You need to know where each file comes from, what schema it claims to follow, and how schema contracts would appear when something breaks.
...
- I can say what `p055` / `optical_experiment_noise_characterization` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `Null policy` using a small example.
- I can explain `Range checks` using the project files or notebook.
- I can explain why `Schema contracts` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p055`
- Project slug: `optical_experiment_noise_characterization`
- Mission ID: `p055-de-l05-m01`
- Central notebook: [`notebooks/tracks/data_engineering/L05/data_engineering_l05_data_quality_and_contracts.ipynb`](../../../../../notebooks/tracks/data_engineering/L05/data_engineering_l05_data_quality_and_contracts.ipynb)
- Project notebook: `projects/optical_experiment_noise_characterization/notebooks/optical_experiment_noise_characterization.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.optical_experiment_noise_characterization.src.pipeline
```
...
The next level is data_engineering:L06, where this idea becomes more technical.
