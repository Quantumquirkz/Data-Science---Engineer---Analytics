...
from projects.material_fatigue_prediction.src.config import SPEC
from projects.material_fatigue_prediction.src.pipeline import run_material_fatigue_prediction_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_material_fatigue_prediction_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
