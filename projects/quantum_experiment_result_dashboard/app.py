...
from projects.quantum_experiment_result_dashboard.src.config import SPEC
from projects.quantum_experiment_result_dashboard.src.pipeline import run_quantum_experiment_result_dashboard_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_quantum_experiment_result_dashboard_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
