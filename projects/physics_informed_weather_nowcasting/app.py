...
from projects.physics_informed_weather_nowcasting.src.config import SPEC
from projects.physics_informed_weather_nowcasting.src.pipeline import run_physics_informed_weather_nowcasting_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_physics_informed_weather_nowcasting_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
