...
from projects.air_quality_hotspot_prediction.src.config import SPEC
from projects.air_quality_hotspot_prediction.src.pipeline import run_air_quality_hotspot_prediction_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_air_quality_hotspot_prediction_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
