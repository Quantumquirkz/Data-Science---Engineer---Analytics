# Scientific Computing L03: Calculus And Linear Algebra
...
In simple terms, this level helps you use derivatives, integrals, and matrix structure to reason about models.
...
Complete or skim scientific_computing:L02 first, then return here if a word feels unfamiliar.
...
- **Gradients**: explain what this means before you try to automate it.
- **Eigenstructure**: identify where it appears in a table, notebook, model, system, or equation.
- **Conditioning**: describe how it can mislead you if you ignore it.
...
Imagine simulating a moving object. You name the state variables, attach units, and ask how conditioning changes the trustworthiness of the computed trajectory.
...
- I can say what `p022` / `experimental_physics_outlier_lab` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `Gradients` using a small example.
- I can explain `Eigenstructure` using the project files or notebook.
- I can explain why `Conditioning` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p022`
- Project slug: `experimental_physics_outlier_lab`
- Mission ID: `p022-sc-l03-m01`
- Central notebook: [`notebooks/tracks/scientific_computing/L03/scientific_computing_l03_calculus_and_linear_algebra.ipynb`](../../../../../notebooks/tracks/scientific_computing/L03/scientific_computing_l03_calculus_and_linear_algebra.ipynb)
- Project notebook: `projects/experimental_physics_outlier_lab/notebooks/experimental_physics_outlier_lab.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.experimental_physics_outlier_lab.src.pipeline
```
...
The next level is scientific_computing:L04, where this idea becomes more technical.
