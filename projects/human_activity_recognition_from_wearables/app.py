...
from projects.human_activity_recognition_from_wearables.src.config import SPEC
from projects.human_activity_recognition_from_wearables.src.pipeline import run_human_activity_recognition_from_wearables_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_human_activity_recognition_from_wearables_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
