# Data Engineering L08: Distributed Data Systems
...
In simple terms, this level helps you design data movement under partitioning, parallelism, and skew.
...
Complete or skim data_engineering:L07 first, then return here if a word feels unfamiliar.
...
- **Sharding**: explain what this means before you try to automate it.
- **Skew mitigation**: identify where it appears in a table, notebook, model, system, or equation.
- **Storage layout**: describe how it can mislead you if you ignore it.
...
Imagine a folder of daily log files. You need to know where each file comes from, what schema it claims to follow, and how storage layout would appear when something breaks.
...
- I can say what `p071` / `renewable_energy_mix_optimizer` is trying to teach.
- I can identify the input, output, and one hidden assumption.
- I can explain `Sharding` using a small example.
- I can explain `Skew mitigation` using the project files or notebook.
- I can explain why `Storage layout` matters.
- I can write one limitation without weakening the value of the project.

## Mission Anchor

- Project ID: `p071`
- Project slug: `renewable_energy_mix_optimizer`
- Mission ID: `p071-de-l08-m01`
- Central notebook: [`notebooks/tracks/data_engineering/L08/data_engineering_l08_distributed_data_systems.ipynb`](../../../../../notebooks/tracks/data_engineering/L08/data_engineering_l08_distributed_data_systems.ipynb)
- Project notebook: `projects/renewable_energy_mix_optimizer/notebooks/renewable_energy_mix_optimizer.ipynb`
- Run command:

```bash
PYTHONPATH=src:. uv run python -m projects.renewable_energy_mix_optimizer.src.pipeline
```
...
The next level is data_engineering:L09, where this idea becomes more technical.
