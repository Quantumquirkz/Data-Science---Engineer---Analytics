...
from projects.seafloor_mapping_interpolation_project.src.config import SPEC
from projects.seafloor_mapping_interpolation_project.src.pipeline import run_seafloor_mapping_interpolation_project_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_seafloor_mapping_interpolation_project_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
