...
from projects.smart_farming_irrigation_optimizer.src.config import SPEC
from projects.smart_farming_irrigation_optimizer.src.pipeline import run_smart_farming_irrigation_optimizer_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_smart_farming_irrigation_optimizer_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
