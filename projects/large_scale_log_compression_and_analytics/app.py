...
from projects.large_scale_log_compression_and_analytics.src.config import SPEC
from projects.large_scale_log_compression_and_analytics.src.pipeline import run_large_scale_log_compression_and_analytics_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_large_scale_log_compression_and_analytics_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
