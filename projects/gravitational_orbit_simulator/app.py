...
from projects.gravitational_orbit_simulator.src.config import SPEC
...
def _load_pipeline(n_samples: int):
    return run_gravitational_orbit_simulator_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
