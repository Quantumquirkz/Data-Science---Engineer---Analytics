...
from projects.fluid_flow_surrogate_model.src.config import SPEC
from projects.fluid_flow_surrogate_model.src.pipeline import run_fluid_flow_surrogate_model_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_fluid_flow_surrogate_model_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
