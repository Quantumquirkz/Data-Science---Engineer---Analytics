...
from projects.manufacturing_defect_physics_informed_classifier.src.config import SPEC
from projects.manufacturing_defect_physics_informed_classifier.src.pipeline import run_manufacturing_defect_physics_informed_classifier_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_manufacturing_defect_physics_informed_classifier_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
