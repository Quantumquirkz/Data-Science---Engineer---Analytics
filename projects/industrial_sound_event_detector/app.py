...
from projects.industrial_sound_event_detector.src.config import SPEC
from projects.industrial_sound_event_detector.src.pipeline import run_industrial_sound_event_detector_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_industrial_sound_event_detector_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
