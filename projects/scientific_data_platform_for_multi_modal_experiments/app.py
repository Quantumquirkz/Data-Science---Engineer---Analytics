...
from projects.scientific_data_platform_for_multi_modal_experiments.src.config import SPEC
from projects.scientific_data_platform_for_multi_modal_experiments.src.pipeline import run_scientific_data_platform_for_multi_modal_experiments_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_scientific_data_platform_for_multi_modal_experiments_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
