...
from projects.weather_front_boundary_detection.src.config import SPEC
from projects.weather_front_boundary_detection.src.pipeline import run_weather_front_boundary_detection_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_weather_front_boundary_detection_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
