...
from projects.pde_based_image_denoising_study.src.config import SPEC
from projects.pde_based_image_denoising_study.src.pipeline import run_pde_based_image_denoising_study_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_pde_based_image_denoising_study_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
