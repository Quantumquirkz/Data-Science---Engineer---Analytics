...
from projects.financial_regime_change_detector.src.config import SPEC
from projects.financial_regime_change_detector.src.pipeline import run_financial_regime_change_detector_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_financial_regime_change_detector_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
