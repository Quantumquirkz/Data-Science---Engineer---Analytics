...
from projects.smart_building_thermal_dynamics_model.src.config import SPEC
from projects.smart_building_thermal_dynamics_model.src.pipeline import run_smart_building_thermal_dynamics_model_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_smart_building_thermal_dynamics_model_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
