...
from projects.cosmic_ray_event_pattern_mining.src.config import SPEC
from projects.cosmic_ray_event_pattern_mining.src.pipeline import run_cosmic_ray_event_pattern_mining_pipeline


@lru_cache(maxsize=1)
def _load_pipeline(n_samples: int):
    return run_cosmic_ray_event_pattern_mining_pipeline(PROJECT_ROOT, n_samples=int(n_samples))
